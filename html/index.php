                    ...
                    <nav class="navbar navbar-expand-lg navbar-light">
                        ...
                        <div class="collapse navbar-collapse main-menu-item" id="navbarSupportedContent">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="features.html">合約資訊</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="pricing.html">智能合約交易資訊</a>
                                </li>
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                        <a class="dropdown-item" href="sha-256eth2.php">文件上傳</a>
                                        <a class="dropdown-item" href="getTransaction.php">數位指紋查詢</a>
										<a class="dropdown-item" href="burndate.php">註銷碳幣</a>
                                    </div>
                                </li>
                                <li class="nav-item dropdown">
                ...
                <div class="col-lg-6">
                    <div class="banner_text">
                        <div class="banner_text_iner">
                            <h1>carbon coin Network</h1>
                            <p>額外碳捕捉即為一種對地球環境有益的作法之一，碳幣與其他進行碳捕捉或減碳的相關組織合作，根據種植與耕作方法來捕捉土壤中儲存的固碳量，發行相對應的碳幣，碳幣發行之目的是為了證明對於環境友善的象徵。</p>
            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-md-6 col-lg-5">
                    <div class="about_us_text">
                        ...
                        <h2>Token transfer <br>
                            Please enter a valid address</h2>
							<form action="index.php" method="post">					                   
					                    Address to:<input type="text" class="form-control" placeholder="enter Address" name="_to">
					                    amount:<input type="text" class="form-control" placeholder="enter amount" name="_value">
					                    <br>
										<input type="submit" value="送出" class="btn_2">
	
					                    <p>先按"送出"再按"確認送出transfer"</p>
					                      <?php
						                  if(isset($_POST['_to']) && isset($_POST['_value'])){
							                  $_to = $_POST['_to'];
							                  $_value = $_POST['_value'];
							                  echo "<h3>目前Address為:</h3>".$_to."<br><h3>amount為:</h3>".$_value;							 
							                  echo '<br><input type="button" id="transfer" value="確認送出" class="btn_2"><br>';
						                    }
					                    ?>
							</form>  			
					        <p>
            ...
            <div class="row align-items-center justify-content-between">
                ...
                <div class="col-md-6 col-lg-5">
                    <div class="about_us_text">
                        ...
                        <h2>Authorized designated address</h2>
                    
					<form action="index.php" method="post">
					spender address:<input type="text" class="form-control" placeholder="enter Address" name=" _spender">
					<br>數量:<input type="text" class="form-control" placeholder="enter amount" name="_value">
					<br>
					<input type="submit" class="btn_2" value="送出">
	
					<p>先按"送出"再按"確認送出approve"</p>
					<?php
						if(isset($_POST['_spender']) && isset($_POST['_value'])){
							$_spender = $_POST['_spender'];
							$_value = $_POST['_value'];
							echo "目前<br>sddres為".$_spender."<br>數量為".$_value;
							echo '<br><input type="button" id="approve" value="確認送出" class="btn_2"><br>';
						}
					?>
				     </form>
...
async function approve(){
			...
			document.getElementById('message').textContent='交易處理中,請稍後';
             Contract.methods.approve(<?php if(isset($_spender) && isset($_value)) echo '"'.$_spender.'","'.$_value.'"' ?>).send({from:accounts[0]})
            .then(function(data){
                //console.log(data);
...
async function transfer(){
			...
			document.getElementById('message').textContent='交易處理中,請稍後';
             Contract.methods.transfer(<?php if(isset($_to) && isset($_value)) echo '"'.$_to.'","'.$_value.'"' ?>).send({from:accounts[0]})
            .then(function(data){
                //console.log(data);
				document.getElementById('message').textContent='交易處理結束';
...
var end = event.raw.data;
var string = "sender:0x" + end.substring(26,66) + "<br>";
	string += "receiver:0x" + end.substring(90,130) + "<br>";
	string += "amount:" + parseInt(end.substring(182,195),16);
...
console.log(event); });
	...
	<?php 
		if(isset($_spender) && isset($_value))
			echo "document.getElementById('approve').addEventListener('click',approve);";
		if(isset($_to) && isset($_value))
		   echo "document.getElementById('transfer').addEventListener('click',transfer);";
	?>
